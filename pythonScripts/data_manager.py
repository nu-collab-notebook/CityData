...
def save_route_data(destination_type, start_postcode, distances, routes):
    """
    Saves route details to the corosponding to destination.
    """
    folder_path = "/content/drive/MyDrive/CityDataNotebook/data/dundee/routes" #change this to config path
